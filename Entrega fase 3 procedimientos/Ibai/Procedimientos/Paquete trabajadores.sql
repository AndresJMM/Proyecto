CREATE OR REPLACE PACKAGE PAC_TRABAJADOR IS
  ...
  PROCEDURE get_trabajador(i_dniTrab IN TRABAJADOR.DNI%TYPE, i_idCent IN TRABAJADOR.IDCENTRO%TYPE, o_cursor OUT G_CURSOR);
...
CREATE OR REPLACE PACKAGE BODY PAC_TRABAJADOR IS
  ...
  PROCEDURE get_trabajador(
    i_dniTrab IN TRABAJADOR.DNI%TYPE, i_idCent IN TRABAJADOR.IDCENTRO%TYPE, o_cursor OUT G_CURSOR
  )AS
  BEGIN
    OPEN o_cursor for
